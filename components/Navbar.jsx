    ...
    <div className="home">
      <div className="nav w-full  bg-black fixed top-0 left-0 text-white text-2xl z-10 ">
        <ul className="flex flex-wrap justify-between items-center max-[920px]:flex-col max-[920px]:items-start">
          ...
          <div className= "menu flex flex-wrap  w-8/12 mr-10 justify-between max-[920px]:flex-col max-[920px]:hidden gap-6 duration-600" >
            <li>
              <Link href="/">Home</Link>
            </li>
            <li>
          ...
          <li className="absolute top-8 right-5 min-[920px]:hidden"><Hamburger toggled={isOpen} toggle={setOpen} onToggle={expand}/></li>
