const events_data = [
  ...
  },
  {
    ...
    descr:
      'In this event there will be a team of four members. There will be four rounds like Emotional Quadrant (EQ), Intelligence Quadrant (IQ), Spiritual Quadrant (SQ), and Physical Quadrant (PQ). Points will be given to each team according to their performance in each round. The score for all the teams is calculated at the end and the team with highest points is the winner.',
  },
];
